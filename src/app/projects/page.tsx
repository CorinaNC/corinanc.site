        ...
        <Container alignContent="center">
            ...
            <Section delay={0.05}>
                ...
                <Section delay={0.1}>
                    ...
                    <Text fontFamily="Inter" textAlign="center">
                        Data Visualization project analyzing fish population patterns in Minnesota lakes. I contributed to the UI design and CSS styling along with some minor frontend changes.
                    </Text>
                </Section>
            </SimpleGrid>
            </Container>
